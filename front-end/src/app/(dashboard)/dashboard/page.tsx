...
const UserDashboard = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', bgcolor: '#121212', color: '#fff' }}>
            {/* AppBar */}
            ...
            <Box sx={{ display: 'flex', flexGrow: 1, marginTop: 8 }}>
                ...
                >
                    <div>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: 2 }}>
                            ...
                            <Box>
                                ...
                                <Typography variant="body2">Email: cloud9night@gmail.com</Typography>
                            </Box>
                        </Box>

                        {/* Menu Links */}
                        <Link href="/" passHref>
                            <Button color="inherit" fullWidth sx={{ justifyContent: 'flex-start', padding: 1 }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        <Link href="https://docs.google.com/document/d/1yMv6Ku2RxctlIyRDWTS6gjDIu8FhOGqs8AKZHOD6rrY/edit" passHref>
                            <Button color="inherit" fullWidth sx={{ justifyContent: 'flex-start', padding: 1 }}>
...
<Box sx={{ display: 'flex', flexDirection: 'column', marginTop: 2 }}>
    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
        {/* Image 1 */}
        <Box sx={{ position: 'relative', width: '200px', height: '200px', bgcolor: '#1f1f1f', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src="images/gallery-1.jpg" alt="Image 1" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            <Button 
                variant="contained" 
        ...
        {/* Image 2 */}
        <Box sx={{ position: 'relative', width: '200px', height: '200px', bgcolor: '#1f1f1f', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src="images/gallery-2.jpg" alt="Image 2" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            <Button 
                variant="contained" 
                sx={{ position: 'absolute', bottom: 0, left: 0, width: '100%' }} 
