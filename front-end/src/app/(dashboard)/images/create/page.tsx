...
setLoading(true);
try{
  const response = await axios.post('http://localhost:3000/api/text_to_image', {
    text_prompt: prompt,
    imageUrl: imageUrl,
            ...
            <Grid item xs={12} sm={4} md={3}>
              <Box sx={{ border: '1px solid #fff', padding: '16px', height: '180%' }}>
                ...
                <Box sx={{ marginBottom: '16px' }}>
                  <IconButton color="primary" aria-label="Image to image" component="label">
               ...
               <Box>
                    <Typography variant="body2" sx={{color: '#fff', marginTop:'8px', marginBottom:'8px' }}>Width</Typography>
                    <Slider
                    value={width}
               ...
               <Box>
                    <Typography variant="body2" sx={{color: '#fff', marginTop:'8px', marginBottom:'8px' }}>Height</Typography>
                    <Slider
                    value={height}
                ...
                <Box sx={{ border: '1px solid #fff', padding: '16px', height: '100%' }}>
                    ...
                    {imageUrl && (
                      <Box sx={{  marginTop: '16px' }}>
                        <img src={imageUrl} alt="Generated" width="100%" height="100%" />
                      </Box>
                    )}
                </Box>
